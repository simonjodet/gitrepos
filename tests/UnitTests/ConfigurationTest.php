...
class ConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('\Gitrepos\Exceptions\BadConfigurationJSON', 'JSON parser returned with error "JSON_ERROR_SYNTAX"');
    ...
    {
        $this->setExpectedException('\Gitrepos\Exceptions\MissingConfigurationEnvironment', 'The configuration file is missing a "default_env" property');
    ...
    {
        $this->setExpectedException('\Gitrepos\Exceptions\BadConfiguration', 'The configuration is missing "my_env" environment');
    ...
    {
        file_put_contents(sys_get_temp_dir() . '/default_env.json', '{"default_env":"my_env","my_env":{"conf1":"value1"}}');
    ...
    {
        file_put_contents(sys_get_temp_dir() . '/default_env.json', '{"default_env":"my_env","my_env":{"conf1":"value1"},"prod":{"conf2":"value2"}}');
        $Configuration = new \Gitrepos\Configuration(sys_get_temp_dir() . '/default_env.json');
